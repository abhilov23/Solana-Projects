...
npx create-solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-token_transfer
# created an pnpm based project
pnpx create-solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-token_transfer
# created an yarn based project
yarn create solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-token_transfer
```
...
cd solana-templates/legacy-token_transfer
```
